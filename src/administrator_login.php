...
if (!empty($_POST['user'])) {
    ...
    $sql = "SELECT * FROM admins WHERE login_id='".mysqli_real_escape_string($link, $loginId)."' AND password='".mysqli_real_escape_string($link, $passwd)."'";
    ...
    if ($row) {
        // ログインに成功
        $_SESSION['admin'] = $row;
        header('location: administrator_traversal.php');
    }
    else {
        // ログインに失敗
        $error = true;
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">脆弱図書館 - 管理画面</a>
            </div>
